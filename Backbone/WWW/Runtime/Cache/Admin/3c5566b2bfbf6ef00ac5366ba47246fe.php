            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>Backbone</h3>
                        <div id="itemBox" class="item-box">
                            <div class="item">
                                <i class="icon-login-user"></i>
                                <input type="text" name="username" placeholder="Email" autocomplete="off" />
                            </div>
                            <span class="placeholder_copy placeholder_un">Email</span>
                            <div class="item b0">
                                <i class="icon-login-pwd"></i>
                                <input type="password" name="password" placeholder="Password" autocomplete="off" />
                            </div>
                            <span class="placeholder_copy placeholder_pwd">Password</span>
<!--                            <div class="item verifycode">
                        ...
                        <div class="login_btn_panel">
                            <button class="login-btn" type="submit">
                                <span class="in"><i class="icon-loading"></i>Logining...</span>
                                <span class="on">Login In</span>
                            </button>
