...
function get_skill($param){
    $res=M('TalentHaveSkill a')->join("__SKILL__ b on a.Skill_ID=b.Skill_ID")->where(array('a.Talent_ID'=>$param))->select();
    $resarr=array();
foreach ($res as $value) {
    $resarr[]="{$value['skill_name']}:{$value['skill_score']}";
}
